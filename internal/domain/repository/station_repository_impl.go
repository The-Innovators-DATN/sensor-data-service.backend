...
func (r *StationDataRepository) FindStationByID(ctx context.Context, id int32) (*model.StationWithLocation, error) {
	...
	location := model.StationLocation{
	...
	return &model.StationWithLocation{
		Station:  station,
		Location: location,
	}, nil
}
...
func (r *StationDataRepository) FilterStations(ctx context.Context, keyword string, waterBodyID, catchmentID, riverBasinID int32) ([]*model.Station, error) {
...
func (r *StationDataRepository) InsertStation(ctx context.Context, st model.Station) error {
...
func (r *StationDataRepository) GetParametersByStationIDs(ctx context.Context, stationIDs []int32) ([]*model.StationParameter, error) {
	...
	if len(stationIDs) == 0 {
		return []*model.StationParameter{}, nil
	}
	...
	var res []*model.StationParameter
	for _, row := range rows {
		res = append(res, &model.StationParameter{
...
func (r *StationDataRepository) GetDistinctParametersByStationIDs(ctx context.Context, stationIDs []int32) ([]*model.Parameter, error) {
	...
	var res []*model.Parameter
	for _, row := range rows {
		res = append(res, &model.Parameter{
...
// ========== RIVER BASIN CRUD ==========
func (r *StationDataRepository) ListRiverBasins(ctx context.Context) ([]*model.RiverBasin, error) {
	...
	var res []*model.RiverBasin
	for _, row := range rows {
		res = append(res, &model.RiverBasin{
			ID:          int32(castutil.ToInt(row["id"])),
			Name:        castutil.ToString(row["name"]),
			Description: castutil.ToString(row["description"]),
			Status:      castutil.ToString(row["status"]),
...
func (r *StationDataRepository) GetRiverBasinByID(ctx context.Context, id int32) (*model.RiverBasin, error) {
...
func (r *StationDataRepository) CreateRiverBasin(ctx context.Context, rb model.RiverBasin) error {
...
func (r *StationDataRepository) UpdateRiverBasin(ctx context.Context, rb model.RiverBasin) error {
...
// ========== WATER BODY CRUD ==========
func (r *StationDataRepository) GetWaterBodyByID(ctx context.Context, id int32) (*model.WaterBody, error) {
...
func (r *StationDataRepository) ListWaterBodies(ctx context.Context) ([]*model.WaterBody, error) {
...
func (r *StationDataRepository) CreateWaterBody(ctx context.Context, wb model.WaterBody) error {
...
func (r *StationDataRepository) UpdateWaterBody(ctx context.Context, wb model.WaterBody) error {
...
func (r *StationDataRepository) GetCatchmentByID(ctx context.Context, id int32) (*model.Catchment, error) {
...
func (r *StationDataRepository) CreateCatchment(ctx context.Context, c model.Catchment) error {
